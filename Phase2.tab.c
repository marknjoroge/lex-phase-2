...
static const yytype_uint8 yyprhs[] =
{
      ...
      22,    24,    27,    29,    31,    33,    37,    41,    43,    47,
      51,    53,    57,    61,    63,    67,    69,    71,    73,    75,
      77,    82,    87,    92,   102,   108,   116
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      39,     0,    -1,     3,    40,     8,    -1,    40,    41,    -1,
      41,    -1,    42,    -1,    44,    -1,    49,    -1,    53,    -1,
      50,    -1,    52,    -1,    43,    34,    -1,    35,    -1,    36,
      -1,    37,    -1,    34,    24,    45,    -1,    45,    31,    46,
      -1,    46,    -1,    47,    25,    47,    -1,    47,    26,    47,
      -1,    47,    -1,    47,    23,    47,    -1,    47,    22,    47,
      -1,    48,    -1,     4,    47,     5,    -1,    11,    -1,    12,
      -1,    14,    -1,    15,    -1,    34,    -1,    20,     4,    34,
       5,    -1,    20,     4,    13,     5,    -1,    51,    40,     7,
      10,    -1,    51,    40,     7,    10,    18,     6,    40,     7,
      10,    -1,    17,     4,    45,     5,     6,    -1,    21,     4,
      45,     5,     6,    40,     7,    -1,    34,    24,    19,     4,
       5,    -1
};
...
{
       0,    40,    40,    42,    43,    46,    46,    46,    46,    46,
      46,    48,    60,    61,    62,    65,    73,    74,    77,    84,
      91,    94,   103,   112,   115,   116,   121,   125,   128,   131,
     134,   135,   138,   139,   142,   147,   152
};
#endif
...
{
  "$end", "error", "$undefined", "START", "LPAREN", "RPAREN", "OP", "CL",
  "END", "COMMA", "ENDE", "INT_LITERAL", "FLOAT_LITERAL", "STRING_LITERAL",
  "TRUE", "FALSE", "ERROR", "IF", "ELSE", "READ", "PRINT", "WHILE",
  "TIMES", "PLUS", "ASG", "EQ", "NE", "LT", "LE", "GT", "GE", "AND", "OR",
  "NOT", "ID", "INT", "FLOAT", "BOOLEAN", "$accept", "Start_Program",
  "statements", "statement", "Dec_stmt", "Type", "assignment_stmt",
  "bexpression", "expression", "exp", "factor", "print_stmt",
  "condition_stmt", "if_head", "while_stmt", "read_stmt", 0
};
#endif
...
#line 48 "Phase2.y"
    {
                        if (findvarInScop((yyvsp[(2) - (2)].symp).name, curscope) == 1) 
                            ...
                            printf("Inserting %s + %s + %s + %s + %s + %s", yytext, (yyvsp[(1) - (2)].symp).name, (yyvsp[(2) - (2)].symp).type, (yyvsp[(1) - (2)].symp).type, (yyvsp[(2) - (2)].symp), (yyvsp[(1) - (2)].symp));
...
#line 94 "Phase2.y"
    { 
                        if ((strcmp(findtype((yyvsp[(1) - (3)].symp).name, curscope), "int") 
                            ...
                            && (strcmp(findtype((yyvsp[(3) - (3)].symp).name, curscope), "int") 
                                || strcmp(findtype((yyvsp[(3) - (3)].symp).name, curscope), "int")) )
...
#line 142 "Phase2.y"
    {
                        if (sizeof((yyvsp[(3) - (5)].symp)) != 44) semantic_error("Type Error: Condition is not a Boolean.");
                    ;}
    break;
...
#line 147 "Phase2.y"
    {
                        if (sizeof((yyvsp[(3) - (7)].symp)) != 44) semantic_error("Type Error: Condition is not a Boolean.");
                    ;}
    break;
